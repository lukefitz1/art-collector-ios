//
//  ArtistCreateServiceDeserializerSpec.swift
//  Specs
//
...
class ArtistCreateServiceDeserializerSpec: QuickSpec {
    
    override func spec() {
        var subject: ArtistCreateServiceDeserializer!

        beforeEach {
            subject = ArtistCreateServiceDeserializer()
        }
