//
//  GeneralInformationCreateServiceDeserializerSpec.swift
//  Specs
//
...
class GeneralInformationCreateServiceDeserializerSpec: QuickSpec {
    ...
    override func spec() {
        var subject: GeneralInformationCreateServiceDeserializer!

        beforeEach {
            subject = GeneralInformationCreateServiceDeserializer()
        }
